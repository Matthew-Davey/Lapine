...
public class BufferExtensionsTests {
    ...
    [InlineData(true, new Byte[] { 0x00 }, new [] { false, false, false, false, false, false, false, false }, new Byte[0])]
    [InlineData(true, new Byte[] { 0x01 }, new [] { true, false, false, false, false, false, false, false }, new Byte[0])]
    [InlineData(true, new Byte[] { 0x02 }, new [] { false, true, false, false, false, false, false, false }, new Byte[0])]
    [InlineData(true, new Byte[] { 0x03 }, new [] { true, true, false, false, false, false, false, false }, new Byte[0])]
    [InlineData(true, new Byte[] { 0x04 }, new [] { false, false, true, false, false, false, false, false }, new Byte[0])]
    [InlineData(true, new Byte[] { 0x05 }, new [] { true, false, true, false, false, false, false, false }, new Byte[0])]
    [InlineData(true, new Byte[] { 0x06 }, new [] { false, true, true, false, false, false, false, false }, new Byte[0])]
    [InlineData(true, new Byte[] { 0x07 }, new [] { true, true, true, false, false, false, false, false }, new Byte[0])]
    [InlineData(true, new Byte[] { 0x01, 0xff }, new [] { true, false, false, false, false, false, false, false }, new Byte[] { 0xff })]
    static public void ReadBits(in Boolean expectedResult, in Byte[] input, in Boolean[] expectedBits, in Byte[] expectedSurplus) {
        var buffer = new ReadOnlyMemory<Byte>(input);
    ...
    [InlineData(true, new Byte[] { 0x01 }, (UInt16)1, new [] { '\x01' }, new Byte[0])]
    [InlineData(true, new Byte[] { 0x01, 0x02 }, (UInt16)2, new [] { '\x01', '\x02' }, new Byte[0])]
    [InlineData(true, new Byte[] { 0x01, 0x02 }, (UInt16)1, new [] { '\x01' }, new Byte[] { 0x02 })]
    ...
    [InlineData(true, new Byte[] { (Byte)'I', 0x00, 0x00, 0x00, 0x01 }, 1, new Byte[0])]
    [InlineData(true, new Byte[] { (Byte)'i', 0x00, 0x00, 0x00, 0x01 }, 1u, new Byte[0])]
    ...
    [InlineData(true, new Byte[] { 0x00, 0x00, 0x00, 0x01 }, 1, new Byte[0])]
    [InlineData(true, new Byte[] { 0x00, 0x00, 0x00, 0x01, 0x00 }, 1, new Byte[] { 0x00 })]
