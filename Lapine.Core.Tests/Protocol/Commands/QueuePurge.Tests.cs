...
public class QueuePurgeTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        ...
        var result = QueuePurge.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        QueuePurge.Deserialize(ref buffer, out _);
...
public class QueuePurgeOkTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        var buffer = ReadOnlyMemory<Byte>.Empty;
        var result = QueuePurgeOk.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        QueuePurgeOk.Deserialize(ref buffer, out _);
