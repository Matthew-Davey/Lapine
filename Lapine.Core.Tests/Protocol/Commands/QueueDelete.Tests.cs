...
public class QueueDeleteTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        ...
        var result = QueueDelete.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        QueueDelete.Deserialize(ref buffer, out _);
...
public class QueueDeleteOkTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        var buffer = ReadOnlyMemory<Byte>.Empty;
        var result = QueueDeleteOk.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        QueueDeleteOk.Deserialize(ref buffer, out _);
