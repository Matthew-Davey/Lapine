...
public class ConnectionStartTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        ...
        var result = ConnectionStart.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        ConnectionStart.Deserialize(ref buffer, out _);
...
public class ConnectionStartOkTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        var buffer = ReadOnlyMemory<Byte>.Empty;
        var result = ConnectionStartOk.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        ConnectionStartOk.Deserialize(ref buffer, out _);
