...
public class QueueDeclareTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        ...
        var result = QueueDeclare.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        QueueDeclare.Deserialize(ref buffer, out _);
...
public class QueueDeclareOkTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        var buffer = ReadOnlyMemory<Byte>.Empty;
        var result = QueueDeclareOk.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        QueueDeclareOk.Deserialize(ref buffer, out _);
