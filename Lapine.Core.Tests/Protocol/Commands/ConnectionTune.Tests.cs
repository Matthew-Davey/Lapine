...
public class ConnectionTuneTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        ...
        var result = ConnectionTune.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        ConnectionTune.Deserialize(ref buffer, out _);
...
public class ConnectionTuneOkTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        var buffer = ReadOnlyMemory<Byte>.Empty;
        var result = ConnectionTuneOk.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        ConnectionTuneOk.Deserialize(ref buffer, out _);
