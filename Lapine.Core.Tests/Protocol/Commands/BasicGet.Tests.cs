...
public class BasicGetTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        ...
        var result = BasicGet.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        BasicGet.Deserialize(ref buffer, out _);
...
public class BasicGetEmptyTests : Faker {
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        BasicGetEmpty.Deserialize(ref buffer, out _);
...
public class BasicGetOkTests : Faker {
    ...
    public void DeserializationFailsWithInsufficientData() {
        var buffer = ReadOnlyMemory<Byte>.Empty;
        var result = BasicGetOk.Deserialize(ref buffer, out _);
    ...
    public void DeserializationReturnsSurplusData() {
        ...
        BasicGetOk.Deserialize(ref buffer, out _);
